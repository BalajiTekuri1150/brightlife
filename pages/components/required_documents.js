    ...
    return(
        <>
            <section className="form">
                <form className="bg-light px-5 pt-5" >
                Please submit minimum of 3 documents mentioned in below list.
                    <div className="row m-5">
                        <div className="col-5 mx-4">
                            <label>Adhar card </label>
                            <input className="form-control form-control-sm" name="adhar_card" type="file" required onChange={handleChange}/>
                        </div>
                        <div className="col-5 mx-4">
                            <label>Birth Certificate</label>
                            <input className="form-control form-control-sm" name="birth_certificate" type="file" required onChange={handleChange}/>
                        </div>
                    </div>
                    <div className="row m-5">
                        <div className="col-5 mx-4">
