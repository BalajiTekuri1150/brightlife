...
const Otp=()=>
{
    ...
    const handleSubmit=async(e)=>
    {
        ...
        // const response=postData1('https://test-api.brightlife.org/brightlife/v2/verify/otp',data1);
        ...
        //         role:role,
        //     }
        //     const result=postData1('https://test-api.brightlife.org/brightlife/signup',data2);
        //     if(role=="sponsor")
        //     {
        //         if(result?.status==true)
        //         {
        //             console.log(result.response.data.id);
        //             setId(result.response.data.id);
        //             console.log(id);
        //             Router.push({
        //                 pathname:'/Sponser',
