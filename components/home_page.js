        ...
        <div className=" navbar-collapse " id="mobilesidemenu">
          <ul className="navbar-nav mr-auto ">
            <li className="nav-item ">
              <a className="nav-link" href="/home_files/our_team">
                {" "}
                Our Team
              </a>
            </li>
            <li className="nav-item">
              <a className="nav-link" href="/home_files/how_works">
                {" "}
                How it works
              </a>
            </li>
            <li className="nav-item">
              <Link className="nav-link" href="/login/logins">
            ...
            <li className="nav-item">
              <Link className="nav-link " href="/register/Register_Page">
      ...
      <div id="homebanner" className="carousel slide" data-ride="">
        ...
        <div className="carousel-inner ">
          <div
            ...
            style={{ backgroundImage: 'url("/img/slider/banner1.jpg")' }}
          >
            <div className="row ">
              <div className="position-real custom-container ">
                <div className="banner-content col-md-9">
                  <div className="">
                    <h1>
                      To make a difference in someone’s life, you don’t have to
                      be rich, or perfect.
                    </h1>
                    <p>
                      Through Brightlife in India more than 150% of kids are
                      getting education.
                    </p>
                    <div className="d-flex">
                      <a className="sponsorship-button" href="/home_files/apply_sponsorship">
              ...
              <div className="position-real custom-container ">
                <div className="banner-content col-md-9">
                  <div className="">
                    ...
                    <div className="d-flex">
                      <a className="sponsorship-button">
                        Apply for Sponsorship
                      </a>
        ...
        <button
          ...
          type="button"
          data-target="#homebanner"
          data-slide="prev"
        >
          <div className="bannerleftarrow">
            {" "}
            ...
            <div className="how-its-work-box">
              ...
              <div className="steps_content">
                ...
                <p className="step-description">
                  Select a kid of your choice From our data base
                </p>
                <div className="or-line" />
                <div className="or-text">or</div>
                <p className="step-description">
                  Donate to Brightlife. we will select a kid for you.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-12 col-lg-4">
            <div className="how-its-work-box">
              ...
              <div className="steps_content">
                <div className="step-title">STEP</div>
                <p className="step-description">
                  Kid selected by you will get 100% money in their accounts.
                </p>
                <div className="or-line" />
                <div className="or-text">or</div>
                <p className="step-description">
                  Brightlife will share information about your kid and use
                  entire money on the kid.
                </p>
              </div>
            </div>
          </div>
          <div className="col-md-12 col-lg-4">
            <div className="how-its-work-box">
              ...
              <div className="steps_content">
                <div className="step-title">STEP</div>
                <p className="step-description">
                  100% high standards of accountability and transparency and
                  annual report will sent to you indicating the progress of your
                  child
                </p>
              </div>
            </div>
    ...
    <section className="sponsored-child-says">
      <div className="row" style={{ width: "100%" }}>
        ...
        <div className="col-md-12 col-lg-4">
          ...
          <div className="sponsored-name">Shalini</div>
          <div className="sponsored-age">14 year girl from Ranchi</div>
          <p>
            brightlife foundation has changed my life by teaching me a basic
            rights and giving me education. and also be lives of many other
            vulnerable children like me.
          </p>
        </div>
    ...
    <section className="testimonials-section">
      <div className="custom-container">
        <div className="row">
          <div className="col-md-12">
            <div className="section-title">
              Our sponsors <span>Testimonials</span>
            </div>
          </div>
        </div>
        <div className="row">
            ...
            <div id="myCarousel" className="carousel slide" data-ride="">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  ...
                  <p className="testimonial-desp">
                    “As a family, we sponsor a child. Being able to change a
                    life gives us great satisfaction. We hope others will be
                    inspired to do the same. Nothing gives more joy than
      ...
      <div className="custom-container">
        <div className="row">
          ...
          <div className="col-lg-3 kids">
            ...
            <p>
              Within just a year, 2000 kids have successfully received
              scholarships to achieve their dreams
            </p>
          </div>
          <div className="col-lg-1">
            <div className="line-sapration" />
          </div>
          <div className="col-lg-4 donors">
            <div className="count-num">1500 </div>
            <div className="count-type">Donors </div>
            <p>
              With 1500 active donors across the globe , we are actively
    ...
    <section className="have-any-question">
      <div className="custom-container">
        ...
        <div className="row d-flex justify-content-center text-center">
          <div className="col-lg-6">
            <p>
              We’re here to help. Send us an email or call us at +44 123 123
              4567 Please feel free to contact our expert.
            </p>
  ...
  <footer id="footer">
    ...
    <div className="custom-container footer-bottom clearfix">
      ...
      <div className="credits">
        {" "}
        <a href="">FAQ’s</a> <a href="">Deposit</a>
      </div>
    </div>
  </footer>
